...
function LoadCollectibles(world)
    ...
    -- collectibles.fixture:setuserData("key")
    ...
    collectible_lifes.life1.fixture = love.physics.newFixture(collectible_lifes.life1.body, collectible_lifes.life1.shape, 2)
    collectible_lifes.life1.fixture:setSensor(true)
    -- collectibles.fixture:setuserData("life")
    ...
    collectible_lifes.life2.fixture = love.physics.newFixture(collectible_lifes.life2.body, collectible_lifes.life2.shape, 2)
    ...
    collectible_lifes.life3.fixture = love.physics.newFixture(collectible_lifes.life3.body, collectible_lifes.life3.shape, 2)
...
function DrawCollectibles()
    if collectible_lifes.counter == 0 and collectible_lifes.counter <= 3 then
        love.graphics.draw(sprites.life, collectible_lifes.life1.body:getX(), collectible_lifes.life1.body:getY(), collectible_lifes.life1.body:getAngle(),
        1, 1, sprites.life:getWidth() / 2, sprites.life:getHeight() / 2)

        love.graphics.draw(sprites.life, collectible_lifes.life2.body:getX(), collectible_lifes.life2.body:getY(), collectible_lifes.life2.body:getAngle(),
        1, 1, sprites.life:getWidth() / 2, sprites.life:getHeight() / 2)

        love.graphics.draw(sprites.life, collectible_lifes.life3.body:getX(), collectible_lifes.life3.body:getY(), collectible_lifes.life3.body:getAngle(),
        1, 1, sprites.life:getWidth() / 2, sprites.life:getHeight() / 2)
    end
    if collectible_key.counter == 0 then
        love.graphics.draw(sprites.key, collectible_key.body:getX(), collectible_key.body:getY(), collectible_key.body:getAngle(),
