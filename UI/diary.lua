...
function DrawSecondPage()
    ...
    love.graphics.print("Today I discovered some shocking \nthings about this place... and a key near \nsome trees but I don't know what unlocks", camera.x + 50, camera.y - 105)
    love.graphics.print("But I can't write what it is right now \nbecause I think I'm being followed.", camera.x + 50, camera.y - 10)
