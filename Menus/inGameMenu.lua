...
function LoadInGameMenu()
    ...
    table.insert(buttons,NewButton("Resume", 
    function()
        gameState = GamePlay
    end))
...
function DrawInGameMenu()
    ...
    love.graphics.setColor(0.1,0.1,0.3, 0.5)
    love.graphics.rectangle("fill", camera.x - width , camera.y - height, width * 2, height * 2)
